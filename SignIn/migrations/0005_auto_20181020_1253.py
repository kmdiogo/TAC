...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('SignIn', '0004_auto_20181018_2156'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='student',
            name='academicYear',
            field=models.CharField(choices=[('FR', 'Freshman'), ('SO', 'Sophomore'), ('JU', 'Junior'), ('SR', 'Senior')], max_length=2, verbose_name='Academic Year'),
        ),
        migrations.AlterField(
            model_name='student',
            name='dob',
